module datapath(clk,PCsrc,WE3,imm_src,Alusrc,alu_ctrl,WE,Result_src,zero,Less,LessUnsigned,Instr);
   input clk,WE3,Alusrc,WE;
	input[1:0] PCsrc;
	input [3:0]alu_ctrl;
	input [2:0]imm_src;
	...
	alu 			ALU	  (SrcA,SrcB,alu_ctrl, Alu_result,zero,Less,LessUnsigned);
